...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head><meta http-equiv="Content-Type" content="text/html; charset=big5">
        <title>Administrador De Lugares De Origen Y Destino</title>
    ...
    <body oncontextmenu="return false">
        <section>  
            <table id="dg" title="Origen Y Destino" class="easyui-datagrid" style="width:800px;height:250px"
                url="origendestino"
                ...
                <thead>
                    <tr>
                        ...
                        <th field="orides" width="50">Origen - Destino</th>
                        <th field="tiempo" width="50">Tiempo Estimado En Minutos</th>
                    </tr>
                </thead>
                <?php foreach($listOrigenDestinos as $origendestino): ?>
                    <?php
                        echo '<tr>
                                <td>'.$origendestino['id'].'</td>
                                <td>'.$origendestino['origendestino'].'</td>
                                <td>'.$origendestino['tiempo'].'</td>
                            </tr>';
                    ?>
                <?php endforeach; ?>
            </table>
            ...
            <div name="dlg" id="dlg" class="easyui-dialog" style="width:300px;height:300px;padding:10px 20px"
                ...
                <div class="ftitle">Origen - Destino</div>
                <form id="formulario" name="formulario" method="post" action="agregar">
                    <input id="idd" name="idd" type="hidden">
                    <div class="fitem">
                        <label>Origen - Destino:</label>
                        <input id="orides" name="orides" class="easyui-textbox" required="true">
                        <label>Tiempo Estimado En Minutos:</label>
                        <input id="tiempo" name="tiempo" class="easyui-textbox" required="true">
                    </div>
                </form>
            </div>
            <div id="dlg-buttons">
            ...
            <div name="dl" id="dl" class="easyui-dialog" style="width:300px;height:250px;padding:10px 20px"
                ...
                <form id="formu" name="formu" method="post" action="eliminar">
                    ...
                    <div class="fitem">
                        <label>Origen - Destino:</label>
                        <input id="orides" name="orides" disabled="true" class="easyui-textbox" required="true">
                        <label>Tiempo Estimado:</label>
                        <input id="tiempo" name="tiempo" disabled="true" class="easyui-textbox" required="true">
                    </div>
                </form>
            </div>
            <div id="dlg-buttons">
