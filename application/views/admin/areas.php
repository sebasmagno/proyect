...
<body oncontextmenu="return false">
    <section>  
        ...
        <?php foreach($listAreas as $vista): ?>
        <?php
            echo '<tr><td>'.$vista['id_visita'].'</td><td>'.$vista['descripcion'].'</td></tr>';
        ?>
        <?php endforeach; ?>
    </table>
    <div id="toolbar">
    ...
    <div name="dlg" id="dlg" class="easyui-dialog" style="width:300px;height:250px;padding:10px 20px"
        ...
        <div class="ftitle">Trabajo Final</div>
    ...
    <div name="dl" id="dl" class="easyui-dialog" style="width:300px;height:250px;padding:10px 20px"
        ...
        <form id="formu" name="formu" method="post" action="eliminar">
            ...
            <div class="fitem">
                <label >Descripcion:</label>
                <input id="descripcion" name="descripcion" class="easyui-textbox" disabled="true" required="true">
            </div>
        </form>
    </div>
    <div id="dlg-buttons">
